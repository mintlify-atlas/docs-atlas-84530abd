...
Notra helps teams transform daily work—merged PRs, closed issues, and Slack conversations—into polished content for changelogs, blog posts, and social media updates.
...
<CardGroup cols={2}>
  <Card title="Connect Your Tools" icon="plug">
    Integrate GitHub, Linear, and Slack to pull product and engineering activity
  </Card>
...
<CardGroup cols={3}>
  <Card title="Ingest Activity" icon="download">
    Pull updates from GitHub, Linear, and Slack into a normalized format
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Review & Publish" icon="check">
    Access ready-to-review content in your dashboard
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Slack" icon="slack" href="/integrations/slack">
    Capture important conversations and announcements
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Event-Based Triggers" icon="bolt" href="/automation/event-based">
    React to GitHub webhooks and generate content when PRs are merged
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Investor Updates" icon="chart-line" href="/content/social-media">
    Progress summaries for stakeholders and investors
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Tone & Language" icon="volume">
...
<AccordionGroup>
  <Accordion title="Automated Weekly Changelogs" icon="calendar-week">
    Set up a **scheduled workflow** that runs every Friday at 5 PM UTC to generate a changelog from the week's merged PRs across all your repositories. Content is automatically created in draft status for review before publishing.
  </Accordion>
  ...
  <Accordion title="Social Media Pipeline" icon="megaphone">
    Create **multiple content types** from a single trigger—when a major PR is merged, automatically generate a technical changelog entry, a blog post draft, and Twitter/LinkedIn announcements.
  </Accordion>
  
  <Accordion title="Monthly Investor Updates" icon="chart-simple">
    Schedule a **monthly summary** that analyzes activity across all repositories and generates an investor-friendly update highlighting progress, metrics, and key achievements.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book" href="/concepts/how-it-works">
    Understand the content pipeline and AI analysis
  </Card>
  <Card title="Integrations Guide" icon="plug" href="/integrations/overview">
    Connect GitHub, Linear, and Slack to your workspace
  </Card>
...
<Note>
  **Need help getting started?** Check out our [Quick Start Guide](/quickstart) or explore our [GitHub repository](https://github.com/usenotra/notra) to see the open-source codebase.
</Note>
